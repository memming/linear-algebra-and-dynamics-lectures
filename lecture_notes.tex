...
\textbf{Remark}: Time evolution of 
\begin{align}
    x(t) &= \phi(t)x(0)
    \\
    x(t+\tau) &= \phi(\tau)x(t)
...
Away from the fixed points, the flow of nonlinear dynamical systems is topologically conujugate to a boring constant flow:
