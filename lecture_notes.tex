...
\vspace{\stretch{0.5}}
\part Can linear neural networks with symmetric matrices oscillate?
\vspace{\stretch{0.2}}
\end{parts}
...
More generally, the spectral theorem extends to the class of normal matrices, but the eigenvalues may be complex-valued.
