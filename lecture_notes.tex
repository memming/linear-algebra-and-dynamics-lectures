...
The traditional tool for analyzing memory traces in a neural system is to use the eigenvalues (also known as spectra).
...
As long as a matrix has $n$ linearly independent (not necessarily orthogonal) eigenvectors, we can diagonalize them using its eigenvectors.
