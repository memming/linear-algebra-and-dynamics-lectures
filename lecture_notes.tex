...
\question Consider a rank-1 neural network with $W = \vu \vv\trp$.
\begin{flalign}
&
    \vu =
    \begin{bmatrix}
...
\question 
According to Eckart-Young theorem, replacing the smallest singular values with $0$ is a good way to achieve low-rank approximation of a matrix.
