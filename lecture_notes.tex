...
\question Con
\begin{parts}
    \part Show that $W \vu_i = \lambda_i \vu_i$, that is, columns of $U$ correspond to right eigenvectors with corresponding eigenvalues as the diagonal elements of $\Lambda$.
	\vspace{\stretch{1}}
