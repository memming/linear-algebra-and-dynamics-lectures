...
\end{align}
Decomposing $X=USV^\top$ the $P$ that solves this optimization problem is given by $V_{1:D}$, making $Y=U_{1:D} S_{1:D}$.  Therefore, if you want to do PCA you only have to be able to take the SVD of the data matrix $X$ and then isolate the columns of $U$ and $V$ associated with the top $D$ singular values.
