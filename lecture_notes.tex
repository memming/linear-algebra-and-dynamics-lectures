...
Consider a network of $N$ linear neurons where each neuron's membrane potential $v_i(t)$ evolves over time as,
\begin{align}
	v_i(t+1) &= w_{i,i} v_i(t) + \sum_{j} w_{i,j} v_j(t) + I_i(t)
\end{align}
